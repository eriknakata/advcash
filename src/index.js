...
export default async ({ password, apiName, accountEmail }) => {
    if (advcashClient) {
      ...
      return {
        ...
        validationSendMoneyToAdvcashCard: (arg1) => advcashClient(
            "validationSendMoneyToAdvcashCard", {
              arg0,
              arg1
            }),

        validationSendMoneyToEcurrency: (arg1) => advcashClient(
        ...
        validationCurrencyExchange: (arg1) => advcashClient(
            "validationCurrencyExchange", {
              arg0,
              arg1
            }),

        validationSendMoneyToEmail: (arg1) => advcashClient(
        ...
        sendMoneyToAdvcashCard: (arg1) => advcashClient(
            "sendMoneyToAdvcashCard", {
              arg0,
              arg1
            }),

        validationSendMoneyToBankCard: (arg1) => advcashClient(
        ...
        validationSendMoneyToBtcE: (arg1) => advcashClient(
        ...
        validationSendMoneyToExmo: (arg1) => advcashClient(
